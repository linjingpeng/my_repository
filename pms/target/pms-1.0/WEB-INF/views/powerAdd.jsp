			  ...
			  <div class="panel-body">
				<form id="userForm" role="form" >
				 <div class="col-sm-4 col-sm-offset-3">
					...
					<div class="col-sm-9">
					<input type="text" class="form-control" id="power_name" placeholder="请输入权限名"><br>
					</div>
				  </div>
				  <div class="col-sm-4 col-sm-offset-3">
					<label class="col-sm-3" for="exampleInputPassword1">请求路径</label>
					<div class="col-sm-9">
					<input type="text" class="form-control" id="power_action" placeholder="请输入请求路径"><br>
					</div>
				  </div>
				  <div class="col-sm-4 col-sm-offset-3">
				  ...
				  <div class="col-sm-4 col-sm-offset-3">
				  <button id="addBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 增加权限</button>
				  </div>
				</form>
			  </div>
			</div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#addBtn").click(function(){
			    	...
			    	$.ajax({
			    		type : "POST",
			    		url  : "${pageContext.request.contextPath }/power/addPower.do",
			    		data : {
			    		...
			    		success : function(result) {
			    			...
			    			if ( result.success ) {
		                        layer.msg("权限增加成功", {time:1000, icon:6}, function(){
		                        	window.location.href = "${pageContext.request.contextPath }/power/toPowerList.do";
		                        });
			    			} else {
		                        layer.msg("权限增加失败，请重新操作", {time:2000, icon:5, shift:6}, function(){
