								...
								<div class="input-group">
									<div class="input-group-addon">
										<select name="condition">
												<option value="complain_people">投诉人</option>
												<option value="complain_phone">手机号码</option>
												<option value="complain_date">投诉日期</option>
												<option value="complain_rname">受理人</option>
										</select>
									</div>
          ...
          //查询
		    $("#query").click(function(){
		    	...
		    	if ( queryText == "" ) {
		    		...
		    		window.location.href = "${pageContext.request.contextPath }/complain/toComplainList.do?"+condition+"="+queryText;
		    	}
