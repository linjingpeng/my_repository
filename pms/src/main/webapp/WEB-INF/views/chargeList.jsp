								...
								<div class="input-group">
									<div class="input-group-addon">
										<select name="condition">
												<option value="charge_mouth">年月份</option>
										</select>
									</div>
          ...
          //查询
		    $("#query").click(function(){
		    	...
		    	if ( queryText == "" ) {
		    		...
		    		window.location.href = "${pageContext.request.contextPath }/charge/toChargeList.do?"+condition+"="+queryText;
		    	}
