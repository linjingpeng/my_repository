								...
								<div class="input-group">
									<div class="input-group-addon">
										<select name="condition">
												<option value="power_name">权限名</option>
												<option value="power_action">请求路径</option>
										</select>
									</div>
          ...
          //查询
		    $("#query").click(function(){
		    	...
		    	if ( queryText == "" ) {
		    		...
		    		window.location.href = "${pageContext.request.contextPath }/power/toPowerList.do?"+condition+"="+queryText;
		    	}
